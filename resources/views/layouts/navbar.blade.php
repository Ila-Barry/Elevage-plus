                ...
                <div class="collapse navbar-collapse" id="mainNavbar">
                    ...
                    <div class="navbar-right d-flex flex-column flex-lg-row align-items-stretch align-items-lg-center">
                        ...
                        <div class="dropdown profile-dropdown">
                            <button class="btn dropdown-toggle profile-button" type="button" id="profileDropdown" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <img src="https://i.pravatar.cc/100" alt="profile" class="profile-image">

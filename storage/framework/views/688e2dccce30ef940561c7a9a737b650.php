            ...
            <div class="modal-body px-4 pb-4">
                <form action="#" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="nom_elevage" class="form-control custom-input" value="<?php echo e($elevage['titre'] ?? 'Élevage bovin de Thiès'); ?>" style="border-radius: 6px; font-size: 14px;" required>
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="localisation" class="form-control custom-input" value="<?php echo e($elevage['local'] ?? 'Thiès, Sénégal'); ?>" style="border-radius: 6px; font-size: 14px;">
                    </div>

<?php $__env->startSection('title', 'Élevages'); ?>

<?php $__env->startPush('styles'); ?>
<link rel="stylesheet" href="<?php echo e(asset('css/eleveurCSS/elevage.css')); ?>">
<?php $__env->stopPush(); ?>
...
<div class="dashboard-wrapper container-fluid py-4">
 ...
 <!-- En-tête avec bouton de création -->
    ...
    <div class="elevages-list d-flex flex-column gap-3 mb-4">
        <?php $__empty_1 = true; $__currentLoopData = $elevages ?? [
        ...
        ]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $elevage): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-12 col-md-3 col-lg-2 text-center text-md-left mb-3 mb-md-0">
                        <div class="img-container">
                            <img src="<?php echo e(asset('images/img-elevage.jpeg')); ?>" alt="Ferme Intégrée" class="img-fluid rounded border">
    ...
    <div class="row no-gutters align-items-stretch">
        ...
        <div class="col-12 col-md-4 col-lg-3 col-image-container">
            <div class="img-container-full">
                <img src="<?php echo e(asset('images/img-elevage.jpeg')); ?>" alt="Ferme Intégrée">
        ...
        <div class="elevage-card bg-white rounded shadow-sm border mb-3">
            <div class="row no-gutters align-items-stretch">
                ...
                <div class="col-12 col-md-4 col-lg-3 col-image-container">
                    <div class="img-container-full">
                        <img src="<?php echo e(asset('images/img-elevage.jpeg')); ?>" alt="Ferme Intégrée" class="img-fluid h-100 w-100 object-fit-cover rounded-left">
                        <div class="img-overlay-text text-uppercase text-center">
                            Ferme Intégrée<br>
                            <small>"Union" - Dakar / Sénégal</small>
                        </div>
                    ...
                    <div class="col-12 col-sm-8 col-md-6 col-lg-7">
                        <h2 class="elevage-card-title text-uppercase mb-3"><?php echo e($elevage['titre']); ?></h2>

                        <div class="elevage-info-grid">
                            <div class="info-item d-flex align-items-center mb-2">
                                <i class="fas fa-map-marker-alt text-danger mr-3 info-icon"></i>
                                <span><strong>Localisation :</strong> <?php echo e($elevage['local']); ?></span>
                            </div>
                            <div class="info-item d-flex align-items-center mb-2">
                                <i class="fas fa-layer-group text-secondary mr-3 info-icon"></i>
                                <span><strong>Superficie :</strong> <?php echo e($elevage['surface']); ?></span>
                            </div>
                            <div class="info-item d-flex align-items-center mb-2">
                                <i class="fas fa-cow text-secondary mr-3 info-icon"></i>
                                <span><strong>Animaux :</strong> <?php echo e($elevage['animaux']); ?></span>
                            </div>
                            <div class="info-item d-flex align-items-center mb-0">
                                <i class="far fa-calendar-alt text-danger mr-3 info-icon"></i>
                                <span><strong>Créé le :</strong> <?php echo e($elevage['date']); ?></span>
                            </div>
                        </div>
                <div class="col-12 col-md-5 col-lg-6 p-4 d-flex flex-column justify-content-center">
                    <h2 class="elevage-card-title text-uppercase mb-3" style="font-size: 1.25rem; font-weight: 700;"><?php echo e($elevage['titre']); ?></h2>
                    ...
                    <div class="elevage-info-grid d-flex flex-column gap-2">
                        <div class="info-item-row pb-1 d-flex align-items-center">
                            ...
                            <span class="text-muted"><?php echo e($elevage['local']); ?></span>
                        </div>
                        ...
                        <div class="info-item-row pb-1 d-flex align-items-center">
                            ...
                            <span class="text-muted"><?php echo e($elevage['surface']); ?></span>
                        </div>
                        ...
                        <div class="info-item-row pb-1 d-flex align-items-center">
                            ...
                            <span class="text-muted"><?php echo e($elevage['animaux']); ?></span>
                        </div>
                        ...
                        <div class="info-item-row pb-1 d-flex align-items-center">
                            ...
                            <span class="text-muted"><?php echo e($elevage['date']); ?></span>
                        </div>
                    </div>
                </div>
...
<<<<<<< HEAD
            ...
            <div class="modal-body px-4 pb-4">
                <div class="text-center mb-3">
                    <img src="<?php echo e(asset('images/img-elevage.jpeg')); ?>" class="img-fluid rounded border mb-2" style="max-height: 180px; object-fit: cover; width: 100%;">
                </div>
...
<?php echo $__env->make('layouts.menu', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Projets\Elevage-plus\resources\views/elevages.blade.php ENDPATH**/ ?>
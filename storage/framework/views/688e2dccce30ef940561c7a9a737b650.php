...
let elevages = [
    {
        ...
        image: '<?php echo e(asset('images/img-elevage.jpeg')); ?>'
    },
    {
        id: 2,
            ...
            <div class="row no-gutters align-items-stretch">
                <div class="col-12 col-md-4 col-lg-3 col-image-container">
                    <div class="img-container-full">
                        <img src="${elevage.image || '<?php echo e(asset('images/img-elevage.jpeg')); ?>'}" alt="${elevage.titre}" class="img-fluid h-100 w-100 object-fit-cover rounded-left">
...
function viewElevage(id) {
    ...
    document.getElementById('viewElevageImage').src = elevage.image || '<?php echo e(asset('images/img-elevage.jpeg')); ?>';
